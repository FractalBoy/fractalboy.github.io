...
var _fountainReader = __webpack_require__(3);

var _fountainReader2 = _interopRequireDefault(_fountainReader);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var API_KEY = "AIzaSyCAO-spugKEwk9MGAX253RhGUHB6H72u5g";
...
var createPicker = function createPicker() {
    if (pickerApiLoaded && oauthToken) {
        ...
        var picker = new google.picker.PickerBuilder().addView(view).addView(new google.picker.DocsUploadView()).setDeveloperKey(API_KEY).setAppId(APP_ID).setOAuthToken(oauthToken).setCallback(pickerCallback).build();
